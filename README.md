...
[![GitHub build status: CI](https://img.shields.io/github/actions/workflow/status/QuingKhaos/FrozenFoodTweaks/ci.yml?branch=main&label=CI&style=for-the-badge&logo=github&logoColor=rgb(0,0,0)&labelColor=rgb(111,148,173))](https://github.com/QuingKhaos/FrozenFoodTweaks/actions?query=workflow%3ACI)
[![GitHub build status: Quality Assurance](https://img.shields.io/github/actions/workflow/status/QuingKhaos/FrozenFoodTweaks/qa.yml?branch=main&label=QA&style=for-the-badge&logo=github&logoColor=rgb(0,0,0)&labelColor=rgb(111,148,173))](https://github.com/QuingKhaos/FrozenFoodTweaks/actions?query=workflow%3A%22Quality+Assurance%22)
[![GitHub issues: bugs](https://img.shields.io/github/issues/QuingKhaos/FrozenFoodTweaks/bug?label=Bug%20Reports&style=for-the-badge&logo=github&logoColor=rgb(0,0,0)&labelColor=rgb(111,148,173))](https://github.com/QuingKhaos/FrozenFoodTweaks/issues?q=is%3Aissue%20state%3Aopen%20label%3Abug)
[![GitHub pull requests](https://img.shields.io/github/issues-pr/QuingKhaos/FrozenFoodTweaks?label=Pull%20Requests&style=for-the-badge&logo=github&logoColor=rgb(0,0,0)&labelColor=rgb(111,148,173))](https://github.com/QuingKhaos/FrozenFoodTweaks/pulls)

# Frozen Food Tweaks

Opinionated tweaks to [Frozen Food](https://mods.factorio.com/mod/FrozenFood). For a full list of changes, take a look
at the changelog.
